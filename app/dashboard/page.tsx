...
function ProfileMenu({ router }: { router: ReturnType<typeof useRouter> }) {
          ...
          {menuItems.map(({ icon, label, action }) => (
            <button
              ...
              style={{
                ...
                fontSize: 13, color: "#0a0814", cursor: "pointer", fontFamily: "'DM Sans', sans-serif",
          ...
          <div style={{ borderTop: "1px solid rgba(232,67,147,0.1)", padding: "4px 0 4px" }}>
            <button
              ...
              style={{
                width: "100%", display: "flex", alignItems: "center", gap: 9,
                padding: "9px 14px", border: "none", background: "transparent",
                fontSize: 13, color: "#e84393", cursor: "pointer", fontFamily: "'DM Sans', sans-serif",
                textAlign: "left", fontWeight: 600, transition: "background .1s",
              }}
